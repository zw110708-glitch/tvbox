...
class Spider(Spider):
    ...
    def init(self, extend=""):
        ...
        if not isinstance(config, dict):
            config = {}
        self.host = config.get("site", "https://www.laosijix.com")
        ...
        self.class_map = {
            ...
            "%E6%9C%89%E5%A4%AB%E4%B9%8B%E5%A6%A6": "有夫之婦",
    ...
    def detailContent(self, ids):
        ...
        for a in soup.select("span.vol-item-info a"):
            ...
            if href:
                ...
                chapters.append(f"{name}${self.plp + href}")
    ...
    def playerContent(self, flag, id, vipFlags=None):
        ...
        try:
            ...
            chapter_url = real_url if real_url.startswith("http") else self._fix_url(real_url)
            if not chapter_url:
            ...
            proxied = [self.plp + img for img in images]
            return {
                "parse": 0,
                "playUrl": "",
