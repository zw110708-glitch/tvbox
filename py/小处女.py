...
class Spider(Spider):
    ...
    def init(self, extend=""):
        self.host = "https://down.nigx.cn/eey.myacetwve.buzz"
        self.home_url = "https://down.nigx.cn/eey.myacetwve.buzz/chu/"
        self.header = {
        ...
        if re.search(r'\.(m3u8|mp4)', url):
            ...
            try:
                ...
                if 'player_data=' in html:
                    ...
                    return {
                        'parse': 0,
                        'url': f'http://127.0.0.1:10079/p/0/127.0.0.1:10172/{play_url}',
                        'header': {
                            'User-Agent': self.header['User-Agent'],
                            'Referer': self.home_url
                        }
                ...
                return {'parse': 1, 'url': f'http://127.0.0.1:10079/p/0/127.0.0.1:10172/{url}', 'header': self.header}
