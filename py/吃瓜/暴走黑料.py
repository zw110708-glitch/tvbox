...
class Spider(BaseSpider):
    ...
    def get_working_host(self):
        dynamic_urls = [
            ...
            'https://hl007.okbktyd8.work/?ch=bagewy',
    ...
    def detailContent(self, ids):
        try:
            ...
            if not vod_content:
                vod_content = data('h1').text() or '暴走黑料'

            return {'list': [{'vod_play_from': '暴走黑料', 'vod_play_url': play_url, 'vod_content': vod_content}]}
        except:
            return {'list': [{'vod_play_from': '暴走黑料', 'vod_play_url': '获取失败'}]}
