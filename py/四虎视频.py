...
class Spider(Spider):
    ...
    def homeVideoContent(self):
        ...
        # 尝试获取首页推荐视频
        try:
            rsp = self.fetch(f'http://127.0.0.1:10079/p/0/127.0.0.1:10172/{self.baseUrl}', headers=self.headers)
    ...
    def categoryContent(self, tid, pg, filter, extend):
        result = {}
        url = f'http://127.0.0.1:10079/p/0/127.0.0.1:10172/{self.baseUrl}/vod/type/id/{tid}/page/{pg}.html'
    ...
    def detailContent(self, array):
        tid = array[0]
        url = f'http://127.0.0.1:10079/p/0/127.0.0.1:10172/{self.baseUrl}/vod/detail/id/{tid}.html'
        rsp = self.fetch(url, headers=self.headers)
        html = etree.HTML(rsp.text)
    ...
    def searchContent(self, key, quick):
        result = {}
        url = f'http://127.0.0.1:10079/p/0/127.0.0.1:10172/{self.baseUrl}/vod/search/page/1/wd/{urllib.parse.quote(key)}.html'
        rsp = self.fetch(url, headers=self.headers)
        html = etree.HTML(rsp.text)
