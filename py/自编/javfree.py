...
# -*- coding: utf-8 -*-
"""
遮天九秘 · javfree.com 爬虫脚本 v8
境界：轮海秘境 · 彼岸境（轻量直取 + 代理转发）
...
class Spider(BaseSpider):
    ...
    def init(self, extend=""):
        """
        初始化并解析外部传入的配置（extend），提取代理设置并挂载到 session。
        extend 可以是 JSON 字符串或字典，例如：
        ...
        try:
            ...
            if extend:
                if isinstance(extend, str):
                    ...
                    cfg = extend
                # 严格按给定格式提取代理：self.proxies = cfg.get("proxies") or {}
